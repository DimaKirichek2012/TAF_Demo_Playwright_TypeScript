...
A layered test automation framework built with **Playwright** and **TypeScript**, demonstrating clean architecture, design patterns, UI and API testing. Test target: [saucedemo.com](https://www.saucedemo.com) + public REST APIs.
